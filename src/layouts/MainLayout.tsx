  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className={`flex-1 overflow-y-auto ${isScanPage ? 'p-0 pb-16 sm:p-0 sm:pb-16 md:p-0 md:pb-16 lg:p-8 lg:pb-8' : 'p-4 pb-20 sm:p-5 sm:pb-20 md:p-6 md:pb-20 lg:p-8 lg:pb-8'}`}>
          <Outlet />
        </main>
      </div>
