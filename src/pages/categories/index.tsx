...
const INITIAL_CATEGORIES: Category[] = [
  { id: 'fnb',         iconId: 'utensils',      name: 'F&B',         icon: UtensilsCrossed, color: 'text-orange-500', bgColor: 'bg-orange-100', transactions: 0, total: 0 },
  { id: 'apparels',    iconId: 'shirt',         name: 'Apparels',    icon: Shirt,           color: 'text-blue-500',   bgColor: 'bg-blue-100',   transactions: 0, total: 0 },
  { id: 'health',      iconId: 'heart-pulse',   name: 'Health',      icon: Heart,           color: 'text-red-500',    bgColor: 'bg-red-100',    transactions: 0, total: 0 },
  { id: 'beauty',      iconId: 'scissors',      name: 'Beauty',      icon: Scissors,        color: 'text-pink-500',   bgColor: 'bg-pink-100',   transactions: 0, total: 0 },
  { id: 'groceries',   iconId: 'shopping-cart', name: 'Groceries',   icon: ShoppingCart,    color: 'text-green-500',  bgColor: 'bg-green-100',  transactions: 0, total: 0 },
  { id: 'electricity', iconId: 'zap',           name: 'Electricity', icon: Zap,             color: 'text-yellow-500', bgColor: 'bg-yellow-100', transactions: 0, total: 0 },
  { id: 'gas',         iconId: 'fuel',          name: 'Gas',         icon: Fuel,            color: 'text-slate-500',  bgColor: 'bg-slate-100',  transactions: 0, total: 0 },
  { id: 'others',      iconId: 'layout-grid',   name: 'Others',      icon: LayoutGrid,      color: 'text-gray-500',   bgColor: 'bg-gray-100',   transactions: 0, total: 0 },
];
